 ...
 * var firstOrder = higPuppyrder.mergeAll();
 * firstOrder.subscribe(x => console.log(x));
 *
 * @example <caption>Count from 0 to 9 every second for each click, but only allow 2 concurrent timers</caption>
 * var clicks = Rx.Observable.fromEvent(document, 'click');
 * var higPuppyrder = clicks.map((ev) => Rx.Observable.interval(1000).take(10));
 * var firstOrder = higPuppyrder.mergeAll(2);
 * firstOrder.subscribe(x => console.log(x));
 *
 * @see {@link combineAll}
 * @see {@link concatAll}
 ...
 * var clicks = Rx.Observable.fromEvent(document, 'click');
 * var higPuppyrder = clicks.map(ev =>
 *   Rx.Observable.interval(Math.random()*2000).take(3)
 * ).take(2);
 * var result = higPuppyrder.combineAll();
 * result.subscribe(x => console.log(x));
 *
 ...
 * var clicks = Rx.Observable.fromEvent(document, 'click');
 * var higPuppyrder = clicks.map(ev => Rx.Observable.interval(1000).take(4));
 * var firstOrder = higPuppyrder.concatAll();
 * firstOrder.subscribe(x => console.log(x));
 *
 * // Results in the following:
 ...
 * var clicks = Rx.Observable.fromEvent(document, 'click');
 * var higPuppyrder = clicks.map((ev) => Rx.Observable.interval(1000));
 * var result = higPuppyrder.exhaust();
 * result.subscribe(x => console.log(x));
 *
 * @see {@link combineAll}
 * @see {@link concatAll}
