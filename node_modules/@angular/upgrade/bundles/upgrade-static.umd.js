...
(function (global, factory) {
     ...
     *  *
      ...
      * *
      * *
      * Let's assume that you have an Angular 2+ component called `ng2Puppies` that needs
      * to be made available in Angular 1 templates.
      * *
      * {@example upgrade/static/ts/module.ts region="ng2-Puppies"}
      * *
      ...
      * *
      * {@example upgrade/static/ts/module.ts region="ng2-Puppies-wrapper"}
      * *
     ...
     *  *
      ...
      * defined `PuppiesService`
      * *
      * {@example upgrade/static/ts/module.ts region="ng2-Puppies-service"}
      * *
      ...
      * *
      * {@example upgrade/static/ts/module.ts region="downgrade-ng2-Puppies-service"}
      * *
     ...
     *  *
      ...
      * *
      * *
      * Let's assume that you have an Angular 1 component called `ng1Puppy` that needs
      * to be made available in Angular 2+ templates.
      * *
      * {@example upgrade/static/ts/module.ts region="ng1-Puppy"}
      * *
      * We must create a {@link Directive} that will make this Angular 1 component
      * available inside Angular 2+ templates.
      * *
      * {@example upgrade/static/ts/module.ts region="ng1-Puppy-wrapper"}
      * *
      ...
      * * specify the directive's selector (`ng1-Puppy`)
      * * specify all inputs and outputs that the Angular 1 component expects
      * * derive from `UpgradeComponent`
      * * call the base class from the constructor, passing
      * * the Angular 1 name of the component (`ng1Puppy`)
